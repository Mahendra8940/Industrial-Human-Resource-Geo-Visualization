...
#set st addbar page
icon = Image.open("C:/Users/CHINNAMUTHU/Desktop/human_resource project/download.png")

st.set_page_config(page_title= "HRM", page_icon= icon, layout= "wide", initial_sidebar_state= "expanded",
                   menu_items={'About': """# This page is created by Mahendran!"""})
...
data = pd.read_csv("C:/Users/CHINNAMUTHU/Desktop/human_resource project/all_of_comined.csv")

unique_states = sorted(data['India/States'].unique())
selected_state = st.sidebar.selectbox("Select State", unique_states, key="state_selector_unique")

filtered_districts = sorted(data[data['India/States'] == selected_state]['India/States'].unique())
...
district_data = data[(data['India/States'] == selected_district)]
...
filtered_nic_names = data[data['India/States'] == selected_district]['NICName'].unique()
