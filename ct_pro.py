...
#set st addbar page
icon = Image.open(r"C:\Users\CHINNAMUTHU\Desktop\human_resource project\download.png")
...
data = pd.read_csv(r"C:\Users\CHINNAMUTHU\Desktop\human_resource project\HRM.csv")
